...
public class RNReactNativeMtkSmartconfigModule extends ReactContextBaseJavaModule {

    private final ReactApplicationContext reactContext;

    public RNReactNativeMtkSmartconfigModule(ReactApplicationContext reactContext) {
        super(reactContext);
